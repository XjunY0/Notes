...
`# 加载模型 new_model = tf.keras.models.load_model('my_model.h5')  # 打印模型架构 new_model.summary()  # 使用模型进行预测 predictions = new_model.predict(x_train[:5]) print(predictions)`
...
~~~
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTEwOTU2OTcsMTE5NTYwNzExMiwxMzM3NT
gwMzgyLDIwMzEyNjU1NjMsMTI4MTMzMzQzNSwtMTg1NTUxNDc4
NSw1ODU5MjA1OTYsLTEyMjE3MjU2MTYsLTE4MjIyOTQzNzddfQ
==
-->